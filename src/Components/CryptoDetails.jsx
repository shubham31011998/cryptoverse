...
import { useGetCryptoDetailsQuery,useGetCryptoHistoryQuery } from '../Components/Services/CryptoApi';
...
const CryptoDetails = () => {
  ...
  console.log('coinId', data, "----", cryptoDetails)
              ...
              <Col className='coin-links'>
                ...
                {cryptoDetails.links.map((link)=>(
                  <Row className='coin-link' key={link.name}>
                    ...
                    <a href={link.url} target="_blank" rel="noreferrence">{link.name}</a>
                  </Row>
                ))}
              </Col>
            </Col>
